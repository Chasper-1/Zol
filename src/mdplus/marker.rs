...
pub const MARKERS: &[MarkerDef] = &[
    ...
    MarkerDef { open: "**",  close: "**",  style: STYLE_BOLD, multiline: false },
    MarkerDef { open: "__",  close: "__",  style: STYLE_UNDERLINE, multiline: false },
    MarkerDef { open: "''",  close: "''",  style: STYLE_SUPERSCRIPT, multiline: false },
