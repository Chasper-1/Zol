...
use crate::editor::utils::{rounded_rect};
...
impl EditorWidget {
    pub fn new(state: EditorState) -> DrawingArea {
        ...
        area.set_draw_func(move |widget, cr, width, height| {
            ...
            let bc = &theme.border_color;
                cr.set_source_rgba(bc.r as f64, bc.g as f64, bc.b as f64, bc.a as f64);
            ...
            st_inner
                .buffer
                .shape_until_scroll(&mut st_inner.font_system, false);
            ...
            let tc = &theme.text.color;
            let color = (tc.r as f64, tc.g as f64, tc.b as f64, tc.a as f64);
